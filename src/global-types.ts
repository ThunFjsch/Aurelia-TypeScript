import { PlacedStructure, RemoteRoomInfrastructure } from "roomManager/basePlanner/planner-interfaces";
...
declare global {
  ...
  interface RoomMemory {
    ...
    isOwned: boolean;
    remotes: string[];
    remoteRooms: RemoteRoomInfrastructure[];
    hasRoads?: boolean;
  ...
  interface BuilderMemory extends CreepMemory {
    target?: Id<ConstructionSite | Structure > | null;
    targetRoom?: string;
